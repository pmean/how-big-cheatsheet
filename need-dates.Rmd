...
1. **format()** or **format.Date()** converts a Date object to a string

2. **strftime()** converts a POSIXt object to string

The **format** (used for Date objects) and **strftime** (used for POSIXt objects) use a format string to layout the date or date/time value in a wide variety of orders and formats.
