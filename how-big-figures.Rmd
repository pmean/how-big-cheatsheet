...
# bottom margin
arrows  (x(302), y(200), x(302), y(300), lwd=3, length=0.05, code=3)
segments(x(302), y(233), x(308), y(233), lwd=3, length=0.05)
...
# right margin
arrows  (x(400), y(302), x(500), y(302), lwd=3, length=0.05, code=3)
segments(x(450), y(302), x(450), y(340), lwd=3)
