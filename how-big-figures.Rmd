...
axis(side=1, pos=y(300), at=x(c(304, 396)), labels=rep(" ", 2)) 
axis(side=2, pos=x(300), at=y(c(304, 396)), labels=rep(" ", 2)) 
...
s1 <- "dev.size()[1] (in, cm, px), fin[1] (in)"
w1 <- strwidth(s1)
text(x(304), y(150), s1, adj=0)
arrows(x(300), y(150), x(200), y(150), len=0.05)
arrows(x(308)+w1, y(150), x(500), y(150), len=0.05)
segments(x(200), y(190), x(200), y(110))
segments(x(500), y(190), x(500), y(110))

# graphics device size (y)
s2 <- "dev.size()[2] (in, cm, px), fin[2] (in)"
w2 <- strwidth(s2)
text(x(150), y(304), s2, adj=0, srt=90)
arrows(x(150), y(300), x(150), y(200), len=0.05)
arrows(x(150), y(308)+w2, x(150), y(500), len=0.05)
segments(x(190), y(200), x(110), y(200))
segments(x(190), y(500), x(110), y(500))

# plotting region size (x)
s3 <- "pin[1] (in)"
w3 <- strwidth(s3)
...
segments(x(300), y(310), x(308), y(310), lty="dotted", lwd=3)
segments(x(500), y(310), x(316)+w4, y(310), lty="dotted", lwd=3)
...
# bottom margin
arrows  (x(302), y(200), x(302), y(300), length=0.05, code=3)
segments(x(302), y(233), x(308), y(233), length=0.05)
text(    x(312), y(233), "mai[1] (in), mar[1] (lines)", adj=0, cex=1.0)

# lower left user coordinates
arrows  (x(267), y(267), x(300), y(300), len=0.05)
segments(x(267), y(267), x(308), y(267))
text    (x(312), y(267), "user[c(1,3)] (user)", adj=0)

# upper right user coordinates
arrows  (x(433), y(433), x(400), y(400), lwd=3, len=0.05)
segments(x(433), y(433), x(360), y(433), lwd=3)
text    (x(356), y(433), "user[c(2,4)] (user)", adj=1)

# top margin
arrows  (x(398), y(400), x(398), y(500), lwd=3, length=0.05, code=3)
segments(x(398), y(467), x(360), y(467), lwd=3)
text    (x(356), y(467), "mai[3] (in), nmar[3] (lines)", adj=1, cex=1.0)

# left margin
arrows  (x(200), y(398), x(300), y(398), lwd=3, len=0.05, code=3)
segments(x(250), y(398), x(250), y(392), lwd=3)
text    (x(250), y(388), "mai[2] (in), mar[2] (lines)", adj=1, srt=90)

# right margin
arrows(x(400), y(300), x(500), y(300), length=0.05, code=3)
segments(x(450), y(300), x(450), y(340))
...
polygon(x=x(c(200, 500, 500, 200)), y=y(c(200, 200, 500, 500)),   lty="dashed")
```
