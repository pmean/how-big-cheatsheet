...
draw_framework <- function(y0=104, y1=196) {
  ...
  polygon(x=c(100, 100, 200, 200), y=c(y0-4, y1+4, y1+4, y0-4), col="olivedrab1", border=NA)
  polygon(x=c(104, 104, 196, 196), y=c(y0,   y1,   y1,   y0),   col="olivedrab",  border="black", lty="dotted")
