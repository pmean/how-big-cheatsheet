...
```{r step9_strheight, fig.width=3.33, fig.height=3.33, echo=FALSE}
draw_framework <- function() {
  ...
  polygon(x=c(100, 100, 200, 200), y=c(100, 200, 200, 100), border=NA, col="olivedrab1")
  polygon(x=c(104, 104, 196, 196), y=c(104, 196, 196, 104), border="black", lty="dotted", col="olivedrab")
  axis(side=1, at=c(104, 196), labels=rep(" ", 2), lwd=2)
  axis(side=2, at=c(104, 196), labels=rep(" ", 2), lwd=2)
}
...
```{r step8_cin2, fig.width=3.33, fig.height=3.33, echo=FALSE}
cin2 <- function() {
  par(cex=0.75)
